    ...
    render() {
        return (
            <React.Fragment>
                    ...
                    <div className="container">
                        <div id="responsive-nav">
                            ...
                            <ul className="category-list">
                                ...
                                <div className="custom-menu">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <img src="./style/img/banner05.jpg" alt />
                            ...
                            <ul className="menu-list">
                                ...
                                <li className="dropdown mega-dropdown"><a className="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Women <i className="fa fa-caret-down" /></a>
                                <div className="custom-menu">
                                    <div className="row">
                                    <div className="col-md-4">
                                        <ul className="list-links">
                                ...
                                <li className="dropdown mega-dropdown full-width"><a className="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Men <i className="fa fa-caret-down" /></a>
                                <div className="custom-menu">
                                    <div className="row">
                                    <div className="col-md-3">
                                        <div className="hidden-sm hidden-xs">
                                        <a className="banner banner-1" href="#">
                                            <img src="./style/img/banner06.jpg" alt />
                                            <div className="banner-caption text-center">
                                    ...
                                    <div className="col-md-3">
                                        <div className="hidden-sm hidden-xs">
                                        <a className="banner banner-1" href="#">
                                            <img src="./style/img/banner07.jpg" alt />
                                            <div className="banner-caption text-center">
                                    ...
                                    <div className="col-md-3">
                                        <div className="hidden-sm hidden-xs">
                                        <a className="banner banner-1" href="#">
                                            <img src="./style/img/banner08.jpg" alt />
                                            <div className="banner-caption text-center">
                                    ...
                                    <div className="col-md-3">
                                        <div className="hidden-sm hidden-xs">
                                        <a className="banner banner-1" href="#">
                                            <img src="./style/img/banner09.jpg" alt />
                                            <div className="banner-caption text-center">
                                ...
                                <li className="dropdown default-dropdown"><a className="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Pages <i className="fa fa-caret-down" /></a>
                ...
                {/* /NAVIGATION */}
                <AppNavigatorSlick></AppNavigatorSlick>
             </React.Fragment>
